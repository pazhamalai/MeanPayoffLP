...
module soft_task2
	...
	[soft2] srct2_1=1 & sd2=6 & sp2_1=9 -> (f2'=0) & (srct2_1'=0) & (sd2'=5) & (sp2_1'=8);

	[soft1] srct2_1=1 & sd2=6 & sp2_1=9 -> (f2'=0) & (srct2_1'=1) & (sd2'=5) & (sp2_1'=8);

	[soft3] srct2_1=1 & sd2=6 & sp2_1=9 -> (f2'=0) & (srct2_1'=1) & (sd2'=5) & (sp2_1'=8);

	[soft4] srct2_1=1 & sd2=6 & sp2_1=9 -> (f2'=0) & (srct2_1'=1) & (sd2'=5) & (sp2_1'=8);

	[none] srct2_1=1 & sd2=6 & sp2_1=9 -> (f2'=0) & (srct2_1'=1) & (sd2'=5) & (sp2_1'=8);

	[soft1] srct2_1=0 & sd2=5 & sp2_1=8 -> (f2'=0) & (srct2_1'=0) & (sd2'=4) & (sp2_1'=7);

	[soft3] srct2_1=0 & sd2=5 & sp2_1=8 -> (f2'=0) & (srct2_1'=0) & (sd2'=4) & (sp2_1'=7);

	[soft4] srct2_1=0 & sd2=5 & sp2_1=8 -> (f2'=0) & (srct2_1'=0) & (sd2'=4) & (sp2_1'=7);

	[none] srct2_1=0 & sd2=5 & sp2_1=8 -> (f2'=0) & (srct2_1'=0) & (sd2'=4) & (sp2_1'=7);
	...
	[soft1] srct2_1=0 & sd2=0 & sp2_1=1 -> (f2'=0) & (srct2_1'=1) & (sd2'=6) & (sp2_1'=9);

	[soft3] srct2_1=0 & sd2=0 & sp2_1=1 -> (f2'=0) & (srct2_1'=1) & (sd2'=6) & (sp2_1'=9);

	[soft4] srct2_1=0 & sd2=0 & sp2_1=1 -> (f2'=0) & (srct2_1'=1) & (sd2'=6) & (sp2_1'=9);

	[none] srct2_1=0 & sd2=0 & sp2_1=1 -> (f2'=0) & (srct2_1'=1) & (sd2'=6) & (sp2_1'=9);

	[soft1] srct2_1=1 & sd2=0 & sp2_1=1 -> (f2'=1) & (srct2_1'=1) & (sd2'=6) & (sp2_1'=9);

	[soft3] srct2_1=1 & sd2=0 & sp2_1=1 -> (f2'=1) & (srct2_1'=1) & (sd2'=6) & (sp2_1'=9);

	[soft4] srct2_1=1 & sd2=0 & sp2_1=1 -> (f2'=1) & (srct2_1'=1) & (sd2'=6) & (sp2_1'=9);

	[none] srct2_1=1 & sd2=0 & sp2_1=1 -> (f2'=1) & (srct2_1'=1) & (sd2'=6) & (sp2_1'=9);
...
module soft_task3
	...
	[soft1] srct3_1=0 & sd3=0 & sp3_1=1 -> (f3'=0) & (srct3_1'=1) & (sd3'=6) & (sp3_1'=7);

	[soft2] srct3_1=0 & sd3=0 & sp3_1=1 -> (f3'=0) & (srct3_1'=1) & (sd3'=6) & (sp3_1'=7);

	[soft4] srct3_1=0 & sd3=0 & sp3_1=1 -> (f3'=0) & (srct3_1'=1) & (sd3'=6) & (sp3_1'=7);

	[none] srct3_1=0 & sd3=0 & sp3_1=1 -> (f3'=0) & (srct3_1'=1) & (sd3'=6) & (sp3_1'=7);

	[soft1] srct3_1=1 & sd3=0 & sp3_1=1 -> (f3'=1) & (srct3_1'=1) & (sd3'=6) & (sp3_1'=7);

	[soft2] srct3_1=1 & sd3=0 & sp3_1=1 -> (f3'=1) & (srct3_1'=1) & (sd3'=6) & (sp3_1'=7);

	[soft4] srct3_1=1 & sd3=0 & sp3_1=1 -> (f3'=1) & (srct3_1'=1) & (sd3'=6) & (sp3_1'=7);

	[none] srct3_1=1 & sd3=0 & sp3_1=1 -> (f3'=1) & (srct3_1'=1) & (sd3'=6) & (sp3_1'=7);
